...
startTimerBtn.addEventListener("touchstart", () => {
  console.log("started");
})
displayMinSec(pomodoro*60);
...
pauseTimerBtn.addEventListener("touchstart", pauseTimer);

resetTimerBtn.addEventListener("touchstart", () => {
  titleTimer.textContent = `Pomodoro Timer`;
  resetTimer(timerValues[`${currentCountdown}`]);
})

pomodoroBtn.addEventListener("touchstart", () => {
  currentCountdown = "pomodoro";
  resetTimer(pomodoro);
  startTimer(pomodoro);
})

shortBreakBtn.addEventListener("touchstart", () => {
  currentCountdown = "short-break";
  resetTimer(shortBreak);
  startTimer(shortBreak);
});

longBreakBtn.addEventListener("touchstart", () => {
  currentCountdown = "long-break";
  resetTimer(longBreak);
  startTimer(longBreak);
});
...
saveBtn.addEventListener("touchstart", applySettings);

colorOverlay.addEventListener("touchstart", () => {
  closeModalWindow();
});
